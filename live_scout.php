            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <?php
                        if (isset($_GET['match'])) {
                            echo("<td class=\"col-mod-2\" scope=\"row\"><input type=\"number\" class=\"form-control number-field\" value=\"" . $_GET['match'] . "\" min=\"0\" max=\"10000\" name=\"matchNumber\"></td>");
                        } else {
                            echo("<td class=\"col-mod-2\" scope=\"row\"><input type=\"number\" class=\"form-control number-field\" value=\"0\" min=\"0\" max=\"10000\" name=\"matchNumber\"></td>");
                        }
                        ?>
                    </tr>
                    <tr>
                        ...
                        <?php
                        if (isset($_GET['team'])) {
                            echo("<td class=\"col-mod-2\" scope=\"row\"><input type=\"number\" class=\"form-control number-field\" value=\"" . $_GET['team'] . "\" min=\"0\" max=\"10000\" name=\"teamNumber\"></td>");
                        } else {
                            echo("<td class=\"col-mod-2\" scope=\"row\"><input type=\"number\" class=\"form-control number-field\" value=\"0\" min=\"0\" max=\"10000\" name=\"teamNumber\"></td>");
                        }
                        ?>
                    </tr>
                    <tr>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <img src="img/field.png" style="max-height: 350px;" />
                        </td>
