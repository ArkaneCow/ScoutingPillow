...
CREATE TABLE events(id int(11) NOT NULL AUTO_INCREMENT, name varchar(100) NOT NULL, PRIMARY KEY(id));
CREATE TABLE [event name]_permissions
CREATE TABLE [event name]_matches
CREATE TABLE [event name]_data
CREATE TABLE teams(id int(11) NOT NULL AUTO_INCREMENT, team int(11) NOT NULL, name varchar(100) NOT NULL, PRIMARY KEY(id));
